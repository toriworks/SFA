...
import fnc.salesforce.android.PullToList.PropertyAnimation.PropertyListener;
...
public class BottomPullToRefreshView extends LinearLayout {
    /** Pull-to-Refresh에서 최대로 끌어올릴 수 있는 위치 값 */
    private static final int MAX_UP_POSITION = 200;
	...
	public boolean touchDelegate(View v, MotionEvent event) {
		...
		switch (action) {
			...
			case MotionEvent.ACTION_MOVE:
				...
				headerLayout.getLayoutParams().height = BottomPullToRefreshView.MAX_UP_POSITION;
				headerLayout.requestLayout();
