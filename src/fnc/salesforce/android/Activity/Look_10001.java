...
import fnc.salesforce.android.Look_10001.Look_10001_Sub;
import fnc.salesforce.android.Look_10001.Look_10001_Sub_Detail;
...
public class Look_10001 extends Activity implements OnClickListener{
	...
	private ImageView btnMenu_Activity;
	...
	private Look_10001_Sub mLook_10001_Sub;
	
	private String strDetailState = "Main";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView( R.layout.look_10001_main );
		...
		mLook_10001_Sub 			= new Look_10001_Sub( this );
        ...
        if( intent.getStringExtra("brandCd") != null ){
        	...
        	strDetailState = intent.getStringExtra("Detail_State");
        }
...
//		TabLayout = new RelativeLayout( mContext ); 
		...
		layoutContetsView.addView( mLook_10001_Sub.setLook_10001_SubView( strBrandCD, strContentsID, "ALL") );
	}
	...
	private void setScrollViewTAbBar(){
		...
		layoutContetsView.addView( mLook_10001_Sub.setLook_10001_SubView( strBrandCD, strContentsID, "SUB_ALL") );
			...
			if( tabImgBtn != null ){
				for( int i = 0; i < MaxTabbCount; i++){
					if( v == tabImgBtn[i] ){
						...
						layoutContetsView.removeAllViews();
						if( i == 0 ){
							layoutContetsView.addView( mLook_10001_Sub.setLook_10001_SubView( strBrandCD, strContentsID, "SUB") );
						} else {
							layoutContetsView.addView( mLook_10001_Sub.setLook_10001_SubView( strBrandCD, CONTENTS_PAGE_ALL_LIST_CONSTANCE.ARR_CONTENTS_CATEGORY_SUB.get( i - 1).ctgryId, "SUB") );
						}
					}
				}
			}
